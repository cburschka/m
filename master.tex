...
\begin{lem}
\label{lem:fo-ord-circuit}Sei $\mathcal{L}$ eine Logik, $\mathbb{B}$
...
dass die Konstruktion von Lemma \ref{lem:fo-ord-circuit} und Lemma
\ref{lem:fo-ord-circuit} angepasst werden kann, indem Majority-Gates
hinzugefügt werden.
\[
...
gesondert, und weisen nach, dass die Konstruktion aus Lemma \ref{lem:fo+c}
