...
entspreched dem vorhergehenden Beweis. Dieser hat offensichtlich die
geforderte Größe $S_{n}=S_{2n+1}'=5\left\Vert \varphi\right\Vert \left(2n+1\right)^{\mathtt{M}\left(\varphi\right)}$.
...
Mit den bereits beschriebenen Konstruktionnen kann aus diesen Formeln
