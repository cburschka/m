...
diese Menge nennen wir den \textbf{kanonischen Support} des Gates
$g$.
...
Gates $g$ nur von der Abbildung $\pi_{\mid\pi^{-1}\mathrm{sp}\left(g\right)}$
abhängt, die die Teilmenge $\pi^{-1}\mathrm{sp}\left(g\right)$ auf
$\mathrm{sp}\left(g\right)$ abbildet. Die Abbildung der übrigen Elemente
ist für $g$ unbedeutend.
\begin{defn}
Sei $g\in G$ 
\end{defn}
