...
(selbst mit disjunkter numerischer Erweiterung) gibt es eine Reduktion
auf den einstelligen Zählquantor:
\begin{prop}
...
Schaltkreisklassen (zumindest bei konstanter Tiefe) echt weniger ausdrücken
können als die allgemein invarianten Schaltkreisfamilien. Dazu wurde
der Satz von Hanf verwendet, und gezeigt, dass die Logik $\mathrm{FO}+\mathbf{ARB}$
