...
kann, ohne die Klasse der $P$-uniformen symmetrischen Schaltkreise
zu verlassen.
\begin{lem}
...
nicht erststufig definierbar \cite{Libkin:2004:EFM:1024196,Immerman1982}.
In $\mathrm{FO+FP}\left[\left\{ E\right\} \right]$ wird diese Klasse
...
\begin{proof}
Die Konstruktion erfolgt induktiv über die Definition von $\mathrm{FO}+\mathrm{LFP}\left[\sigma\right]$:
\begin{casenv}
