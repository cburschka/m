...
\begin{lem}
(Lemma 19 aus \cite{anderson_et_al:LIPIcs:2014:4445}) Für $\epsilon\in\mathbb{R}_{\left[0,1\right[}$,
jedes hinreichend große Universum $U=\left[1,n\right]$ mit $n\geqslant\exp\frac{4}{\epsilon}$
...
\begin{lem}
(Lemma 20 aus \cite{anderson_et_al:LIPIcs:2014:4445}) Für $\epsilon\in\mathbb{R}_{\left[0,1\right[}$,
jedes hinreichend große Universum $U\coloneqq\left[1,n\right]$ mit
$n\geqslant\exp\frac{8}{\epsilon^{2}}$ und jede Partition $\mathcal{P}$
mit mit $\left|\mathcal{P}\right|\leqslant\frac{n}{2}$ gilt:
...
\[
\max\left\{ \left|P\right|\mid P\in\mathcal{P}\right\} \geqslant n-\frac{33}{\epsilon}\cdot\frac{\log s}{\log n}
\]
\end{lem}
\begin{proof}
...
Ohne Beschränkung der Annahme ist $p_{k-1}>1$, denn sonst ist $p_{k}=n-\left(k-1\right)\geqslant n-\frac{n}{2}$,
und $\frac{n}{2}\leqslant\frac{}{}\frac{33}{\epsilon}$
