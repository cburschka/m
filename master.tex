...
Johann Makowsky, 1997-1998 \cite{Makowsky:1997:ID:648040.744731,Makowsky1999})
...
die Menge aller Partitionen von $U$. Sei $\sim_{\mathcal{P}}$ die
...
ist, und $\mathcal{P}_{1},\mathcal{P}_{2}\in\mathrm{Part}_{U}$ wie
folgt sind, 
\begin{eqnarray*}
...
Wir führen den \textbf{Stabilisator} als Untergruppe von $\mathrm{Sym}_{U}$
ein.
\begin{defn}
...
Der \textbf{Punktstabilisator }einer Teilmenge $X\subseteq U$ in
...
Der \textbf{Mengenstabilisator} von $X$ in $U$ sei die Untergruppe
...
\mathrm{Stab}_{U}\left\{ X\right\}  & \coloneqq & \left\{ \pi\in\mathrm{Sym}_{U}\mid\pi X=X\right\} \\
 & = & \bigcup_{\pi\in\mathrm{Sym}_{X}}\left(\pi\cup\mathbf{id}_{U\backslash X}\right)\mathrm{Stab}_{U}\left(X\right)
\end{eqnarray*}
...
\section{Träger einer Permutationsgruppe}
\begin{defn}
