...
Zur Unterscheidung wird das Universum $\left[0,n\right]$ umbenannt
zu $N\coloneqq\left\{ \dot{0},\cdots,\dot{n}\right\} $ und $\Upsilon\left(n\right)\coloneqq\left(N,\leqslant\right)$
betrachtet.
