...
definierbar \cite{Libkin:2004:EFM:1024196,Immerman1982}. In $\mathrm{FO+FP}\left[\left\{ E\right\} \right]$
...
\chi^{\left(i\right)}\left(\bar{z}\right) & \coloneqq & \exists\bar{u}\left(\bar{u}=\bar{z}\wedge\exists\bar{x}\left(\bar{x}=\bar{u}\wedge\psi^{\left(i\right)}\left(\bar{x}\right)\right)\right)\\
